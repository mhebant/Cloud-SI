...
document.write('<div class="box" style="width:<?php echo $widht; if ($widht != '100%') echo 'px'; ?>;height:<?php echo $height; if ($height != '100%') echo 'px'; ?>">');
	...
	document.write('<div class="content">');
		document.write('<div class="iframe" style="height:<?php echo $iframeheight; ?>px">');
			document.write('<div class="left"></div>');
			document.write('<div class="right"></div>');
			document.write('<iframe width="100%" height="100%" frameborder="0" scrolling="auto" src="/MHfr78/tool/comment/comment.php?app=<?php echo $app; ?>" ></iframe>');
		document.write('</div>');
